(function () {
    ...
    ***************************************************************************** */
    ...
    includeVendorScripts([
        ...
        {
            release: 'kedappsp.min.js',
            debug: 'kedappsp.js'
        }
    ]);
    includeHTML("<div class=\"ked-sp\"></div>");
    executeClientScript(function () {
        ReactDOM.render(React.createElement(KED.components.KEDAppCourseViewerKS, {}, null), jQuery('div.ked-sp').last()[0]);
    }, []);
