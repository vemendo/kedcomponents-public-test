(function () {
    ...
    ***************************************************************************** */
    ...
    includeVendorScripts([
        {
            release: 'kedappteacherview.min.js',
            debug: 'kedappteacherview.js'
        }
    ]);
    var CSS = CDN + "/css";
    ...
    includeHTML("<div class=\"ked-teacherview\"></div>");
    executeClientScript(function () {
        ReactDOM.render(React.createElement(KED.components.KEDAppTeacherView, {
            courseBuilderUrl: KED.cfg.KED_COURSE_BUILDER_URL
        }, null), jQuery('div.ked-teacherview').last()[0]);
    }, []);
