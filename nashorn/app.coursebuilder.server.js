(function () {
    ...
    ***************************************************************************** */
    ...
    // Element Variables:
    var FEEDBACK_URL = scriptVars.FEEDBACK_URL;
    // vendor scripts
    includeVendorScripts([
        // Assume react, react-dom, vendors.js is already included on the page by kedcomponents element!
        {
    ...
    executeClientScript(function (feedbackUrl) {
        ReactDOM.render(React.createElement(KED.components.KEDAppCourseBuilder, {
            viewCourseUrl: KED.cfg.KED_COURSE_VIEWER_URL,
