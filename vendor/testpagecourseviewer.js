...
var Dialogs = /** @class */ (function (_super) {
    ...
    Dialogs.prototype.handleOutsideClick = function (e) {
        // ignore clicks on the component itself / ignore if a button is clicked (like open new popup/close popup)
        if (this.lastDiv && this.lastDiv.contains(e.target)) {
            return;
        }
        this.props.popDialog();
        e.stopPropagation();
    };
    Dialogs.prototype.onKeyPress = function (ev) {
        if (ev.which === 13 && (!ev.target || ev.target.tagName !== 'TEXTAREA')) {
            jquery__WEBPACK_IMPORTED_MODULE_4___default()(Object(react_dom__WEBPACK_IMPORTED_MODULE_3__["findDOMNode"])(this.lastDiv)).find('.btn-default').click();
        }
        ev.stopPropagation();
    };
    Dialogs.prototype.onKeyDown = function (ev) {
        ...
        if (ev.which === 83 && (ev.ctrlKey || ev.metaKey)) { // CTRL-S
            var domNode = Object(react_dom__WEBPACK_IMPORTED_MODULE_3__["findDOMNode"])(this.lastDiv);
            ev.preventDefault();
    ...
    Dialogs.prototype.render = function () {
        ...
        return dialogs.length > 0 && react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", null, dialogs.map(function (dialog, idx) {
            return react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { key: idx },
                ...
                react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: "modal-page-wrap", onClick: _this.handleOutsideClick },
                    react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: "modal-page", ref: function (elem) {
                            if (idx === dialogs.length - 1)
                                _this.lastDiv = elem;
                        }, tabIndex: 0, "aria-disabled": idx < dialogs.length - 1, onKeyPress: _this.onKeyPress, onKeyDown: _this.onKeyDown },
                        dialog,
