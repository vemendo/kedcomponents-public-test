...
var CourseViewer = /** @class */ (function (_super) {
    ...
    CourseViewer.prototype.load = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var courseId, taskId, moduleName, routeWithTaskParams, course, _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        courseId = Object(_utils_query_string__WEBPACK_IMPORTED_MODULE_7__["parseQueryString"])(location.search)["courseId"];
                        taskId = Object(_utils_query_string__WEBPACK_IMPORTED_MODULE_7__["parseQueryString"])(location.search)["taskId"];
                        moduleName = Object(_utils_query_string__WEBPACK_IMPORTED_MODULE_7__["parseQueryString"])(location.search)["module"];
                        if (taskId && moduleName) {
                            routeWithTaskParams = location.search.replace("module=" + moduleName + "&taskId=", "#/" + moduleName + "/");
                            location.replace(routeWithTaskParams);
                        }
