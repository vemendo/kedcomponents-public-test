...
var KedBackendClientWeb = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(KedBackendClientWeb, _super);
...
var HttpError = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(HttpError, _super);
    ...
    KedBackendClient.prototype.list = function (table, options, fetchOptions) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        query = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, options);
...
var BatchRunner = /** @class */ (function () {
    ...
    BatchRunner.prototype.put = function (table, doc) {
        doc = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, doc);
    ...
    BatchRunner.prototype.update = function (table, id, deltaDoc, branchId) {
        deltaDoc = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, deltaDoc);
...
var RestClient = /** @class */ (function () {
    ...
    RestClient.prototype.suspenseFetch = function (path, method, headers, query, fetchOptions) {
        ...
        if (entry) {
            ...
            var promise = this.fetch(path, method, headers, query, fetchOptions).then(function (res) { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
                var status, text;
                return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                ...
                switch (_e.label) {
                    case 0:
                        if (fetchOptions && fetchOptions.cache === 'no-cache') {
                            ...
                            query = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), { nocache: Object(_utils__WEBPACK_IMPORTED_MODULE_1__["createUUID"])() });
                        }
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.isomorphic.fetch(url, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.fetchOptions), { headers: headers, method: method }), fetchOptions))];
                    case 6:
                        res = _e.sent();
    ...
    RestClient.prototype.post = function (path, data, fetchOptions) {
        ...
        }, null, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, fetchOptions), { body: JSON.stringify(data) }));
    };
    RestClient.prototype.delete = function (path, query, body, fetchOptions) {
        return this.fetch(path, "DELETE", { Accept: "application/json; text/plain" }, query, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, fetchOptions), { body: body }));
    };
    return RestClient;
}());
        ...
        switch (m.op) {
            case 'add-related':
                ...
                if (m.branchId === branchId &&
                    ...
                    deltas = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])([{
                            type: 'add',
                            sourceId: m.id,
            ...
            case 'undo-link':
                    ...
                    return "continue";
                {
                    ...
                    if (optimistic) {
                        ...
                        deltas = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(deltas.slice(0, idx), [
                            Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, deltaRelation), { $meta: optimistic ? 'removing' : 'persisted' })
                        ], deltas.slice(idx + 1));
                    }
                    else {
                        // Persisted. Just remove it:
                        deltas = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(deltas.slice(0, idx), deltas.slice(idx + 1));
                    }
                }
                break;
            case 'update':
                    ...
                    return "continue"; // m applies to tags not listened for
                {
                    ...
                    if (idx < 0) {
                        ...
                        var contributors = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(existingDeltaDoc.contributors);
                        ...
                        if (!optimistic && Object.keys(newData).length === 0) {
                            ...
                            ], deltas.slice(0, idx), deltas.slice(idx + 1));
                        }
                    }
                }
                break;
...
var DeltaCacheEntry = /** @class */ (function () {
    ...
    DeltaCacheEntry.prototype.fail = function (error) {
        var copy = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(this.subscribers);
        this.subscribers = [];
...
var DeltaCollection = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(DeltaCollection, _super);
    ...
    DeltaCollection.prototype.tag = function (tag) {
        return new DeltaCollection(this.deltaCache, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.query), { tag: tag }));
    };
...
function applyDelta(doc, delta) {
    ...
    for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
        var key = keys_1[_i];
        if (targetDoc === doc)
            targetDoc = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, doc);
        var val = delta[key];
                    ...
                    switch (mi) {
                        ...
                        case "$add": {
                            ...
                            if (!Array.isArray(targetArray)) {
                                ...
                                targetArray = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(targetArray); // On JS side, we must be immutable
                            }
...
function mergeDeltas(delta1, delta2, _a) {
    ...
    var targetDelta = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, delta1);
                ...
                var _loop_2 = function (mi) {
                    ...
                    switch (mi) {
                        ...
                        case "$add": {
                            ...
                            targetMetaProp = targetMetaProp ? Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, targetMetaProp) : {};
                            ...
                            targetAddArray = targetAddArray ? Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(targetAddArray, valuesToAdd_2) : Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(valuesToAdd_2);
                        ...
                        case "$remove": {
                            ...
                            var targetRemoveArray = targetMetaProp.$remove;
                            targetRemoveArray = targetRemoveArray ? Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(targetRemoveArray, valuesToRemove_2) : Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(valuesToRemove_2);
...
var KedBackendCollection = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(KedBackendCollection, _super);
    ...
    KedBackendCollection.prototype.applyQuery = function (query) {
        return new KedBackendCollection(this.repo, this.table, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.query), query));
    };
...
var KedBackendQuery = /** @class */ (function () {
    ...
    KedBackendQuery.queryKey = function (table, query) {
        var mutationsOnEmpty = query.mutationsOnEmpty, comparableProps = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"])(query, ["mutationsOnEmpty"]);
    ...
    KedBackendQuery.prototype.queryServer = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repo.getClient().list(this.table, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.query))];
                    case 1:
                        data = _a.sent();
                    ...
                    includes.forEach(function (label) {
                        ...
                        if (includedDocs) {
                            ...
                            if (updatedArray !== includedDocs) {
                                doc = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, doc), (_a = {}, _a[label] = updatedArray, _a));
                            }
                        }
                    });
                    return doc;
                ...
                if (table === m.table) {
                    if (listOptions.tags) {
                        ...
                        if (m.doc.tags && m.doc.tags.some(function (tag) { return queriedTags_1.includes(tag); })) {
                            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(data, [m.doc]); // Make the added doc appear in the result (optimistic mutation)
                        }
                    }
            ...
            case 'add-related':
                if (table === m.table && includes.indexOf(m.graphProp) !== -1) {
                    ...
                    return Object(_ked_backend_client_utils__WEBPACK_IMPORTED_MODULE_1__["updateArray"])(data, function (doc) {
                        ...
                        if (doc.id !== m.id)
                            return doc;
                        var relatedDoc = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, m.relatedDoc);
                        if (optimistic)
                            relatedDoc.$meta = 'adding';
                        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, doc), (_a = {}, _a[m.graphProp] = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(doc[m.graphProp], [relatedDoc]), _a));
                    });
                }
            ...
            case 'remove-related':
                if (table === m.table && includes.indexOf(m.graphProp) !== -1) {
                    return Object(_ked_backend_client_utils__WEBPACK_IMPORTED_MODULE_1__["updateArray"])(data, function (doc) {
                        ...
                        if (doc.id !== m.id)
                            return doc;
                        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, doc), (_a = {}, _a[m.graphProp] = optimistic ?
                            // Mark related-doc-to-remove with $meta: 'deleting'
                            includedDocs.map(function (d) { return d.id !== m.relatedDoc.id ?
                                d : Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, d), { $meta: 'deleting' }); }) :
                ...
                if (listOptions.hasEdgesFrom) {
                    if (sourceIds.includes(m.id))
                        return optimistic ?
                            data.map(function (d) { return d.id === m.relatedDoc.id ? Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, d), { $meta: 'deleting' }) : d; }) :
                    ...
                    if (labels_1.length > 0) {
                        return Object(_ked_backend_client_utils__WEBPACK_IMPORTED_MODULE_1__["updateArray"])(data, function (doc) {
                            labels_1.forEach(function (_a) {
                                ...
                                if (relatedDocs) {
                                    doc = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, doc), (_b = {}, _b[label] = optimistic ?
                                        relatedDocs.map(function (d) { return d.id === m.id ? Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, d), { $meta: 'deleting' }) : d; }) :
    ...
    KedBackendQuery.prototype.setGraphProps = function (doc) {
        var copy = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, doc);
...
var KedBackendRepo = /** @class */ (function () {
    ...
    KedBackendRepo.prototype._clone = function (queryOptions, cacheOptimized) {
        var clone = new KedBackendRepo(this.getClient, this.getUser, this.getUserDisplayName, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.defaultQueryOptions), queryOptions), this.mutationQueue, this.querySet, this.writer, cacheOptimized === undefined ? this.cacheOptimized : cacheOptimized);
        return clone;
    };
...
var MutationQueue = /** @class */ (function () {
    ...
    MutationQueue.merge = function (queue1, queue2) {
        var mutableQueue1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(queue1);
        var mutableQueue2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(queue2);
        ...
        var _loop_1 = function (i) {
            ...
            if (m.op === 'update') {
                ...
                if (overlappingIdOpIdx >= 0) {
                    mutableQueue1[i] = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, m), { deltaDoc: Object(_delta_merge__WEBPACK_IMPORTED_MODULE_2__["mergeDeltas"])(m.deltaDoc, mutableQueue2[overlappingIdOpIdx].deltaDoc) });
...
var Value = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(Value, _super);
...
/***/ "./src/apis/bearer-ked-schedule.ts":
/*!*****************************************!*\
  !*** ./src/apis/bearer-ked-schedule.ts ***!
  \*****************************************/
/*! exports provided: KedScheduleBearerProvider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "KedScheduleBearerProvider", function() { return KedScheduleBearerProvider; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var kedbackend_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! kedbackend/client */ "./kedbackend/client.js");
...
var KedScheduleBearerProvider = /** @class */ (function () {
    function KedScheduleBearerProvider(baseUrl) {
        this.kedScheduleUrl = baseUrl;
    }
    KedScheduleBearerProvider.prototype.getBearer = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var _a;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(!this.bearer || this.bearer.expires < Date.now())) return [3 /*break*/, 2];
                        _a = this;
                        return [4 /*yield*/, this.refreshBearer()];
                    case 1:
                        _a.bearer = _b.sent();
                        _b.label = 2;
                    case 2: return [2 /*return*/, this.bearer];
                }
            });
        });
    };
    KedScheduleBearerProvider.prototype.refreshBearer = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var bearer, kedScheduleResponse, token;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _globals_KED_env__WEBPACK_IMPORTED_MODULE_2__["env"].bearerProvider.getBearer()];
                    case 1:
                        bearer = _a.sent();
                        if (!bearer) {
                            throw new kedbackend_client__WEBPACK_IMPORTED_MODULE_1__["HttpError"](500, "bearer token could not be retrieved");
                        }
                        return [4 /*yield*/, fetch(this.kedScheduleUrl + "exchangetoken", {
                                method: 'post',
                                body: bearer.token
                            })];
                    case 2:
                        kedScheduleResponse = _a.sent();
                        return [4 /*yield*/, kedScheduleResponse.text()];
                    case 3:
                        token = _a.sent();
                        if (!kedScheduleResponse.ok)
                            throw new kedbackend_client__WEBPACK_IMPORTED_MODULE_1__["HttpError"](kedScheduleResponse.status, token);
                        return [2 /*return*/, { token: token, expires: Date.now() + 59 * 60 * 1000 }];
                }
            });
        });
    };
    return KedScheduleBearerProvider;
}());
...
/* harmony import */ var _mock_mock_classroom_data__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./mock/mock-classroom-data */ "./src/apis/mock/mock-classroom-data.ts");
    ...
    EdsClient.prototype.getSchoolTuitionGroups = function (q) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (q.schoolName === undefined) {
                            try {
                                return [2 /*return*/, _mock_mock_classroom_data__WEBPACK_IMPORTED_MODULE_8__["mockTuitionGroups"][q.courseCode]];
                            }
                            catch (e) {
                                return [2 /*return*/, []];
                            }
                        }
                        return [4 /*yield*/, this.http.get("SchoolTuitionGroups", Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.privatizingCacheBust()), q))];
                    case 1:
                        res = _c.sent();
                        if (!(res.status != 200)) return [3 /*break*/, 3];
                        _a = kedbackend_client__WEBPACK_IMPORTED_MODULE_1__["HttpError"].bind;
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (q.schoolName === undefined) {
                            try {
                                return [2 /*return*/, _mock_mock_classroom_data__WEBPACK_IMPORTED_MODULE_8__["mockTuitionStudents"][q.tuitionGroupName]];
                            }
                            catch (e) {
                                return [2 /*return*/, []];
                            }
                        }
                        return [4 /*yield*/, this.http.get("TuitionGroupStudents", Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.privatizingCacheBust()), q))];
                    case 1:
                        res = _c.sent();
                        if (!(res.status != 200)) return [3 /*break*/, 3];
                        _a = kedbackend_client__WEBPACK_IMPORTED_MODULE_1__["HttpError"].bind;
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (q.schoolName === undefined) {
                            try {
                                return [2 /*return*/, _mock_mock_classroom_data__WEBPACK_IMPORTED_MODULE_8__["mockTeachers"]];
                            }
                            catch (e) {
                                return [2 /*return*/, []];
                            }
                        }
                        return [4 /*yield*/, this.http.get("SchoolTeachers", Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.privatizingCacheBust()), q))];
                    case 1:
                        res = _c.sent();
                        if (!(res.status != 200)) return [3 /*break*/, 3];
                        _a = kedbackend_client__WEBPACK_IMPORTED_MODULE_1__["HttpError"].bind;
...
/***/ "./src/apis/ked-scheduleclient.ts":
/*!****************************************!*\
  !*** ./src/apis/ked-scheduleclient.ts ***!
  \****************************************/
/*! exports provided: KedScheduleClient */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "KedScheduleClient", function() { return KedScheduleClient; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var kedbackend_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! kedbackend/client */ "./kedbackend/client.js");
...
var KedScheduleClient = /** @class */ (function () {
    function KedScheduleClient(isomorphic, baseUrl, bearerProvider) {
        var _this = this;
        this.http = new kedbackend_client__WEBPACK_IMPORTED_MODULE_1__["RestClient"](isomorphic, baseUrl, { bearerProvider: bearerProvider });
        var isApiMethod = function (m) {
            return typeof _this[m] === 'function' &&
        ...
        Object.keys(kedbackend_client__WEBPACK_IMPORTED_MODULE_1__["RestClient"].prototype).forEach(function (method) {
            if (isApiMethod(method)) {
                _this[method] = Object(kedbackend_client__WEBPACK_IMPORTED_MODULE_1__["avoidSimultanousCalls"])(_this[method]);
            }
        });
    }
    KedScheduleClient.prototype.getCurrentScheduleEvents = function (q) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var query, response, ex_1;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        if (q) {
                            if (q.schoolyear)
                                query.year = q.schoolyear;
                            if (q.weeknr)
                                query.week = q.weeknr;
                        }
                        return [4 /*yield*/, this._getKedScheduleList("schedule", query)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response];
                    case 2:
                        ex_1 = _a.sent();
                        console.error("Error trying to retrieve Ked Schedule Events: " + ex_1);
                        throw new Error(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["L"])(templateObject_1 || (templateObject_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Error trying to retrieve Ked Schedule Events"], ["Error trying to retrieve Ked Schedule Events"]))));
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    KedScheduleClient.prototype.getTypesList = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var response, ex_2;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._getKedScheduleList("type")];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response];
                    case 2:
                        ex_2 = _a.sent();
                        console.error("Error trying to retrieve Ked Schedule Types: " + ex_2);
                        throw new Error(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["L"])(templateObject_2 || (templateObject_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Error trying to retrieve Ked Schedule Types"], ["Error trying to retrieve Ked Schedule Types"]))));
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    KedScheduleClient.prototype.getLocationsList = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var response, ex_3;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._getKedScheduleList("location")];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response];
                    case 2:
                        ex_3 = _a.sent();
                        console.error("Error trying to retrieve Ked Schedule Locations: " + ex_3);
                        throw new Error(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["L"])(templateObject_3 || (templateObject_3 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Error trying to retrieve Ked Schedule Locations"], ["Error trying to retrieve Ked Schedule Locations"]))));
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    KedScheduleClient.prototype.getInvolvedTeachersList = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var response, ex_4;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._getKedScheduleList("teacher")];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response];
                    case 2:
                        ex_4 = _a.sent();
                        console.error("Error trying to retrieve Ked Schedule Teachers: " + ex_4);
                        throw new Error(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["L"])(templateObject_4 || (templateObject_4 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Error trying to retrieve Ked Schedule Teachers"], ["Error trying to retrieve Ked Schedule Teachers"]))));
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    KedScheduleClient.prototype._getKedScheduleList = function (type, query) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var res, _a, _b, json;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.http.get(type, query ? query : null)];
                    case 1:
                        res = _c.sent();
                        if (!(res.status != 200)) return [3 /*break*/, 3];
                        _a = kedbackend_client__WEBPACK_IMPORTED_MODULE_1__["HttpError"].bind;
...
var DeleteStandardCourse = Object(react_router__WEBPACK_IMPORTED_MODULE_4__["withRouter"])(Object(_utility_components_live_query_view__WEBPACK_IMPORTED_MODULE_2__["liveQueryView"])(function (_a) {
    ...
    spinner: react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("p", null,
        ...
        react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_course_builder_sub_components_spinner__WEBPACK_IMPORTED_MODULE_6__["TimeoutSpinner"], null))
}));
...
var LazyBanner = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(LazyBanner, _super);
    function LazyBanner() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
                                            ...
                                            react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: "align-vertical" },
                                                ...
                                                react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", null,
                                                    react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: "btn-group" }, block.steps.map(function (step) { return react__WEBPACK_IMPORTED_MODULE_1__["createElement"](react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], { key: step.stepNo },
                                                        react__WEBPACK_IMPORTED_MODULE_1__["createElement"](react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Link"], { to: step.link, className: "btn btn-small step-button" +
                                                                (step.isActive ? " activePage" : "") +
                                                                (modifiedItems && modifiedItems["blockStep:" + block.id + ":" + step.stepNo] ? " has-modifications" : "") }, step.stepNo),
                                        ...
                                        react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: 'horizontalMenu' },
                                            react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_utility_components_lazy_content__WEBPACK_IMPORTED_MODULE_4__["LazyContent"], null, _this.dragState.map(function (_a) {
                                                ...
                                                return react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("ul", { className: sortableTabs ? "sortable" : null, onDrop: onTabDrop ? function (ev) {
                                                        ...
                                                        _this.dragState.dispatch(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, _this.dragState.value), { tabBeingHovered: '', tabBeingDragged: '' }));
                                                    } : null },
                                                    tabs.map(function (_a, idx) {
                                                        var name = _a.name, key = _a.key, link = _a.link, onClick = _a.onClick, draggable = _a.draggable, hidden = _a.hidden;
                                                        var isActive = activeTab === key || (activeTab === '$' && idx === 0);
                                                        var dragState = _this.dragState;
                                                        name = name || Object(_utils_utils__WEBPACK_IMPORTED_MODULE_7__["L"])(templateObject_1 || (templateObject_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["(Namnl\u00F6s flik)"], ["(Namnl\u00F6s flik)"])));
                                                        return react__WEBPACK_IMPORTED_MODULE_1__["createElement"](react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], { key: key },
                                                            ...
                                                            react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("li", { className: [
                                                                    ...
                                                                    modifiedItems && modifiedItems["tab:" + key] ? "has-modifications" : "",
                                                                ].filter(function (x) { return x; }).join(' '), draggable: sortableTabs && draggable, onDragStart: sortableTabs && draggable ? function (ev) {
                                                                    ev.dataTransfer.effectAllowed = "move";
                                                                    dragState.dispatch(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, dragState.value), { originClientX: ev.clientX, tabBeingDragged: key }));
                                                                } : null, onDragOver: sortableTabs ? function (ev) {
                                                                    if (tabBeingDragged === key) {
                                                                        dragState.dispatch(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, dragState.value), { tabBeingHovered: '' }));
                                                                        return;
                                                                    }
                                                                    if (!tabBeingDragged)
                                                                        return;
                                                                    ...
                                                                    dragState.dispatch(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, dragState.value), { tabBeingHovered: key, insertBefore: originClientX > ev.clientX }));
                                                                } : null, onDragEnd: function (ev) {
                                                                    _this.dragState.dispatch(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, dragState.value), { tabBeingHovered: '', tabBeingDragged: '' }));
...
function computeGradesFromGradeSpan(gradeSpan) {
    ...
    var _a = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(gradeSpan.split("-"), 2), start = _a[0], end = _a[1];
    var resultGrades = [];
    if (start && end) {
...
function getStandardCoursesWithOrderedRequirements(courseCodes) {
    ...
    return (_a = _globals_db__WEBPACK_IMPORTED_MODULE_2__["db"].courses.include("abilities", "centralContent", "knowledgeRequirements")).tags.apply(_a, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(courseCodeTags)).filter(function (course) { return course.isTemplate; }) // BUGBUG: In KG, we would need this filter, not KS. Need another authorized way of getting the standard course only!
        .map(function (course) { return (Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, course), { abilities: Object(_ordered_requirements__WEBPACK_IMPORTED_MODULE_3__["getOrderedDocs"])(course.abilities, course.abilitiesOrder), centralContent: Object(_ordered_requirements__WEBPACK_IMPORTED_MODULE_3__["getOrderedDocs"])(course.centralContent, course.centralContentOrder), knowledgeRequirements: Object(_ordered_requirements__WEBPACK_IMPORTED_MODULE_3__["getOrderedDocs"])(course.knowledgeRequirements, course.knowledgeRequirementsOrder) })); }).toValue();
}
...
function resolveRequirementOrder(obj, orderDefiner) {
    ...
    if (orderDefiner) {
        ...
        orderDefiningDocObservable = (_a = _globals_db__WEBPACK_IMPORTED_MODULE_2__["db"].courses).tags.apply(_a, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(courseCodes)).cacheOptimized().toValue();
    }
...
/*!******************************************************************!*\
  !*** ./src/components/course-builder-ks/logic/publish-course.ts ***!
  \******************************************************************/
/*! exports provided: publishEntireCourse, publishCoursePart */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "publishEntireCourse", function() { return publishEntireCourse; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "publishCoursePart", function() { return publishCoursePart; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
function publishEntireCourse(_a) {
    var school = _a.school, draftRepo = _a.draftRepo, course = _a.course;
    return publishCourse({ school: school, draftRepo: draftRepo, course: course });
}
function publishCoursePart(_a) {
    var school = _a.school, draftRepo = _a.draftRepo, tab = _a.tab, course = _a.course;
    return publishCourse({ school: school, draftRepo: draftRepo, tab: tab, course: course });
}
function publishCourse(_a) {
    var school = _a.school, draftRepo = _a.draftRepo, tab = _a.tab, course = _a.course;
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
        var tagToMerge, destinationRepo, schoolBranchId;
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_b) {
            switch (_b.label) {
                case 0:
                    tagToMerge = tab ? getTagToMerge(tab) : null;
                    if (!(school === "standard")) return [3 /*break*/, 1];
                    // Editing Standard School should merge to reality.
                    draftRepo.merge({ tagToMerge: tagToMerge });
                ...
                case 2:
                    ...
                    draftRepo.merge({ targetBranchId: schoolBranchId, tagToMerge: tagToMerge });
...
function getTagToMerge(tab) {
    return tab.type === 'step-course-tab' ?
        tab.tags.find(function (tag) { return tag.startsWith("blockStep:"); }) :
        "tab:" + tab.id;
}
...
function sanityCheck(course) {
    function hasDuplicateTasks(course) {
        ...
        return Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["flatten"])(course.modules.map(function (module) { return module.taskIds.map(function (taskId) {
            if (taskIds[taskId]) {
                ...
                return Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["L"])(templateObject_1 || (templateObject_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Samma uppgift f\u00F6rekommer flera g\u00E5nger: \"", "\""], ["Samma uppgift f\u00F6rekommer flera g\u00E5nger: \"", "\""])), task.name);
            }
            taskIds[taskId] = true;
        ...
        return course.tasks.map(function (task) {
            if (task.url) {
                if (taskUrls[task.url]) {
                    return Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["L"])(templateObject_2 || (templateObject_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Tv\u00E5 uppgifter pekar p\u00E5 samma URL: \"", "\" samt \"", "\""], ["Tv\u00E5 uppgifter pekar p\u00E5 samma URL: \"", "\" samt \"", "\""])), taskUrls[task.url].name, task.name);
                }
    ...
    function hasEmptyModuleNames(course) {
        return course.modules.some(function (module) { return module.name === ""; }) && Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["L"])(templateObject_3 || (templateObject_3 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Det finns minst en modul utan angivet namn"], ["Det finns minst en modul utan angivet namn"])));
    }
    function hasDuplicateModuleNames(course) {
        var moduleNames = {};
        return course.modules.map(function (module) {
            if (module.name && moduleNames[module.name]) {
                return Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["L"])(templateObject_4 || (templateObject_4 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Modulen med namn ", " f\u00F6rekommer flera g\u00E5nger"], ["Modulen med namn ", " f\u00F6rekommer flera g\u00E5nger"])), module.name);
            }
            if (module.name)
...
var AdminMenuItems = [
    { name: "schools", text: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_4__["L"])(templateObject_1 || (templateObject_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Skolor"], ["Skolor"]))), route: "/schools" },
    { name: "subjects", text: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_4__["L"])(templateObject_2 || (templateObject_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\u00C4mnen"], ["\u00C4mnen"]))), route: "/subjects" },
];
var NonAdminMenuItems = [
    { name: "courseBuilder", text: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_4__["L"])(templateObject_3 || (templateObject_3 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Kursbyggaren"], ["Kursbyggaren"]))), route: "/courses/new" },
    { name: "studentPage", text: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_4__["L"])(templateObject_4 || (templateObject_4 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Elevsida"], ["Elevsida"]))), route: "" },
    { name: "feedback", text: react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("span", null,
            react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("i", { className: "far fa-comment-dots", "aria-hidden": "true" }),
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (file.size > 2 * 1024 * 1024) {
                        Object(_utils_utils__WEBPACK_IMPORTED_MODULE_4__["showError"])(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_4__["L"])(templateObject_5 || (templateObject_5 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Kan inte ladda upp bilder st\u00F6rre \u00E4n 2 MB"], ["Kan inte ladda upp bilder st\u00F6rre \u00E4n 2 MB"]))));
                        return [2 /*return*/];
                    }
                    form = new FormData();
                ...
                case 1:
                    res = _a.sent();
                    if (res.status !== 200) {
                        Object(_utils_utils__WEBPACK_IMPORTED_MODULE_4__["showError"])(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_4__["L"])(templateObject_6 || (templateObject_6 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Kunde inte ladda upp filen till Google Storage"], ["Kunde inte ladda upp filen till Google Storage"]))));
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, res.text()];
                case 2:
                ...
                case 7:
                    if (url == null) {
                        Object(_utils_utils__WEBPACK_IMPORTED_MODULE_4__["showError"])(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_4__["L"])(templateObject_7 || (templateObject_7 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Kunde inte hitta n\u00E5gon bild i inneh\u00E5llet"], ["Kunde inte hitta n\u00E5gon bild i inneh\u00E5llet"]))));
                        return [2 /*return*/];
                    }
...
function getPartialContentDefaultView(requirement, partialRequirments, alreadyCoveredPartialRequirments, isMarked) {
    ...
    // the requirement can be marked on current tab without saved sentences or all sentences are marked
    var allReqSentencesMarked = isMarked && (!rowRequirments || rowRequirments.length == 0) || allRequirementSentecesMarked(requirement.name, rowRequirments);
...
function getCoveredSenteces(allReq, requirementId) {
    ...
    allReq.forEach(function (obj) {
        ...
        resultArray.push.apply(resultArray, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(assignedReq));
    });
...
var EditSchool = function (props) { return react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { style: { outline: 0 } },
    ...
    react__WEBPACK_IMPORTED_MODULE_1__["createElement"](EditSchoolNoBanner, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, props))); };
var EditSchoolNoBanner = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(EditSchoolNoBanner, _super);
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        school = _a.sent();
                        this.origSchool = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, school);
                        this.setState(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, school));
                        return [3 /*break*/, 3];
                    case 2:
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        school = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.state), { tags: (this.state.tags || [])
                        ...
                        if (!(school.isGymnasium || school.isPrimarySchool)) {
                            throw new Error(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_3__["L"])(templateObject_1 || (templateObject_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Skolan m\u00E5ste antingen vara gymnasium eller grundskola"], ["Skolan m\u00E5ste antingen vara gymnasium eller grundskola"]))));
                        }
                        if (!this.origSchool) {
...
var EditableSchoolList = function (props) {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: "editable-school-list" },
        react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", null, schools ? react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("table", null,
            ...
            react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_sub_components_spinner__WEBPACK_IMPORTED_MODULE_6__["TimeoutSpinner"], null),
            "V.g. v\u00E4nta medan skolor laddas")),
        react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("br", null),
        schools && isAdmin && react__WEBPACK_IMPORTED_MODULE_1__["createElement"](react_router_dom__WEBPACK_IMPORTED_MODULE_4__["Link"], { to: "/schools/new/" + props.type, className: "btn" }, props.type == 'gymnasium' ? Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["L"])(templateObject_1 || (templateObject_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["L\u00E4gg till gymnasieskola"], ["L\u00E4gg till gymnasieskola"]))) :
            props.type == 'primary' ? Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["L"])(templateObject_2 || (templateObject_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["L\u00E4gg till grundskola"], ["L\u00E4gg till grundskola"]))) : Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["L"])(templateObject_3 || (templateObject_3 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["L\u00E4gg till skola"], ["L\u00E4gg till skola"])))));
};
var templateObject_1, templateObject_2, templateObject_3;
...
var SchoolsWithoutBanner = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(SchoolsWithoutBanner, _super);
...
var KnowledgeMatrix = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(KnowledgeMatrix, _super);
        ...
        return react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("table", { className: "knowledge-matrix" },
            ...
            react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("tbody", null, rows.map(function (row, i) { return react__WEBPACK_IMPORTED_MODULE_1__["createElement"](react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], { key: i },
                react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("tr", null, row.map(function (requirement, j) {
                    ...
                    // We check for isMarkedNotOk for the old saved values without partial requirements (sentences saved in the database)
                    ...
                    return requirement && markBySentenceView && markPartialFeatureEnabled ? _this.getKnowledgeSentencesContent(requirement, rowPartialRequirements, j, isMarkedOK, isMigrated) :
                        react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("td", { key: j, dangerouslySetInnerHTML: { __html: requirement ? (rowPartialRequirements && rowPartialRequirements.length || hasPartialCovered) ?
                                    Object(_knowledge_matrix_partial_utils__WEBPACK_IMPORTED_MODULE_3__["getPartialContentDefaultView"])(requirement, rowPartialRequirements, coveredPartialRequirments, isMarkedOK) : requirement.name : "" }, className: (markMode ? "selectable" : "") +
                                (isMigrated ? " migrated" : "") +
...
var SelectRelatedDocs = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(SelectRelatedDocs, _super);
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, Promise.all(expandedCourseTemplates.map(function (courseTemplate) { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
                            var _a;
                            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
...
function diffSubjectGlobalTexts(dbTextMap, xmlTexts) {
    ...
    try {
        for (var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(dbTextMap.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
            var _d = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(_c.value, 2), oldText = _d[0], oldId = _d[1];
...
function getIdsToMigrate(dbTexts, xmlTexts, newTexts, textType, course) {
    ...
    dbTexts = dbTexts.map(function (entity) { return (Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, entity), { name: entity.name.trim() })); }).filter(function (_a) {
        var name = _a.name;
        return !!name;
    });
    var xmlSet = new Map();
    ...
    idsToMigrate.forEach(function (match) {
        ...
        if (oldText && newText) {
            if (Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(getLexemes(oldText)).join(' ') === Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(getLexemes(newText)).join(' ')) {
                match.isTypoFix = true;
            }
        }
    });
    console.log("IdsToMigrate", Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(idsToMigrate.values()).map(function (_a) {
        var oldText = _a.oldText, lexemes = _a.lexemes;
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(lexemes).join(' ') + ": " + oldText;
    }));
    return idsToMigrate;
    function findBestMatch(xmlText) {
        var xmlLexemes = getLexemes(xmlText.html);
        var possiblePartners = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(idsToMigrate.entries()).filter(function (_a) {
            var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(_a, 2), id = _b[0], x = _b[1];
            return x.gradeStep === xmlText.gradeStep;
        })
            .map(function (_a) {
            var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(_a, 2), id = _b[0], _c = _b[1], gradeStep = _c.gradeStep, matchLevel = _c.matchLevel, newText = _c.newText, lexemes = _c.lexemes;
            return ({
                id: id,
                gradeStep: gradeStep,
        ...
        function migrateTasks() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
                        ...
                        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, _globals_KED_env__WEBPACK_IMPORTED_MODULE_3__["default"].kedBackendClient.list("tasks", Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, options), { hasEdgesTo: ids }))];
                                case 1: 
                ...
                return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            oldIds = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(abilityIdsToMigrate.keys(), Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["flatten"])(idsToMigratePerCourse.map(function (c) { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(c.ccsToMigrate.keys(), c.krsToMigrate.keys()); }))).filter(function (id) { return !id.startsWith('fictiveOldId'); });
                            importDate = Date.now();
                        ...
                        case 1:
                            ...
                            _loop_2 = function (task) {
                                ...
                                try {
                                    for (var _e = (e_8 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(task.abilities)), _f = _e.next(); !_f.done; _f = _e.next()) {
                                        var id = _f.value.id;
                                        _loop_3(id);
                                    }
                                }
                                ...
                                try {
                                    for (var idsToMigratePerCourse_1 = (e_9 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(idsToMigratePerCourse)), idsToMigratePerCourse_1_1 = idsToMigratePerCourse_1.next(); !idsToMigratePerCourse_1_1.done; idsToMigratePerCourse_1_1 = idsToMigratePerCourse_1.next()) {
                                        ...
                                        if (taskCourseCodes.size === 0 || taskCourseCodes.has(courseCode)) {
                                            ...
                                            try {
                                                for (var _h = (e_10 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(task.centralContent)), _j = _h.next(); !_j.done; _j = _h.next()) {
                                                    var id = _j.value.id;
                                                    _loop_4(id);
                                                }
                                            }
                                            ...
                                            try {
                                                for (var _k = (e_11 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(task.knowledgeRequirements)), _l = _k.next(); !_l.done; _l = _k.next()) {
                                                    var id = _l.value.id;
                                                    _loop_5(id);
                                                }
                                            }
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_p) {
            switch (_p.label) {
                case 0:
                    ...
                    try {
                        for (orderedAbilities_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(orderedAbilities), orderedAbilities_1_1 = orderedAbilities_1.next(); !orderedAbilities_1_1.done; orderedAbilities_1_1 = orderedAbilities_1.next()) {
                    ...
                    try {
                        for (courseSets_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(courseSets), courseSets_1_1 = courseSets_1.next(); !courseSets_1_1.done; courseSets_1_1 = courseSets_1.next()) {
                            template = courseSets_1_1.value.template;
                            try {
                                for (_a = (e_4 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(template.centralContent)), _b = _a.next(); !_b.done; _b = _a.next()) {
                                    cc = _b.value;
                            ...
                            try {
                                for (_c = (e_5 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(template.knowledgeRequirements)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                    kr = _d.value;
                    ...
                    _loop_1 = function (template, instances) {
                        ...
                        try {
                            ...
                            for (var instances_1 = (e_12 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(instances)), instances_1_1 = instances_1.next(); !instances_1_1.done; instances_1_1 = instances_1.next()) {
                    ...
                    try {
                        ...
                        for (courseSets_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(courseSets), courseSets_2_1 = courseSets_2.next(); !courseSets_2_1.done; courseSets_2_1 = courseSets_2.next()) {
...
var ShowSubjectInner = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(ShowSubjectInner, _super);
    ...
    ShowSubjectInner.prototype.render = function () {
        if (!this.state.subject)
            return react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("p", null,
                react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_sub_components_spinner__WEBPACK_IMPORTED_MODULE_3__["TimeoutSpinner"], null));
...
var ShowSubject = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(ShowSubject, _super);
    ...
    ShowSubject.prototype.render = function () {
        if (!this.state.subject)
            return react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("p", null,
                react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_sub_components_spinner__WEBPACK_IMPORTED_MODULE_4__["TimeoutSpinner"], null));
        var _a = this.state.subject, name = _a.name, code = _a.code, courseTemplates = _a.courseTemplates, schoolType = _a.schoolType;
        return react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", null,
...
var SubjectsInner = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(SubjectsInner, _super);
    ...
    SubjectsInner.prototype.onImportSuccess = function (subject) {
        Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["showInfo"])(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["L"])(templateObject_3 || (templateObject_3 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Importen av ", " lyckades"], ["Importen av ", " lyckades"])), subject));
    ...
    SubjectsInner.prototype.render = function () {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", null, this.state.uploadedSubject ?
            ...
            : this.state.isListingSubjects ?
                react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", null,
                    react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("p", null,
                        react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_sub_components_spinner__WEBPACK_IMPORTED_MODULE_10__["TimeoutSpinner"], null),
                        "Var god v\u00E4nta medan \u00E4mnen h\u00E4mtas...")) :
                react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", null,
                    react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("h2", null, Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["L"])(templateObject_4 || (templateObject_4 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Gymnasie\u00E4mnen"], ["Gymnasie\u00E4mnen"])))),
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("h2", null, Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["L"])(templateObject_5 || (templateObject_5 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Grundskole\u00E4mnen"], ["Grundskole\u00E4mnen"])))),
...
var UploadedSubject = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(UploadedSubject, _super);
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 3:
                        ...
                        try {
                            for (_a = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(subjectToImport.abilities), _b = _a.next(); !_b.done; _b = _a.next()) {
                                a = _b.value;
                                _loop_1(a);
                            }
                        }
                        ...
                        _loop_2 = function (c) {
                            ...
                            try {
                                for (var _d = (e_3 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(c.centralContent)), _e = _d.next(); !_e.done; _e = _d.next()) {
                            ...
                            try {
                                for (var _g = (e_4 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(c.knowledgeRequirements)), _h = _g.next(); !_h.done; _h = _g.next()) {
                                    var cr = _h.value;
                                    _loop_4(cr);
                                }
                            }
                            ...
                            try {
                                ...
                                for (var subjectAbilities_1 = (e_5 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(subjectAbilities)), subjectAbilities_1_1 = subjectAbilities_1.next(); !subjectAbilities_1_1.done; subjectAbilities_1_1 = subjectAbilities_1.next()) {
                        ...
                        try {
                            for (_c = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(subjectToImport.courses), _d = _c.next(); !_d.done; _d = _c.next()) {
                                c = _d.value;
                                _loop_2(c);
                            }
                        }
    ...
    UploadedSubject.prototype.render = function () {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", null,
            react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("h1", null, Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["L"])(templateObject_1 || (templateObject_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Uppladdat \u00C4mne ", ""], ["Uppladdat \u00C4mne ", ""])), subjectToImport ? subjectToImport.name : '')),
                    ...
                    this.state.isImporting ? react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("p", null, "Importerar...") :
                        this.state.changes.every(function (c) { return !c.change; }) ? // Inga ändringar att visa (bara pseudo-ändringar)
                            ...
                            react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", null,
                                ...
                                react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("br", null)),
            react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("button", { onClick: function () { return _this.setState({ showFullText: !_this.state.showFullText }); } }, this.state.showFullText ? Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["L"])(templateObject_2 || (templateObject_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["D\u00F6lj nedan"], ["D\u00F6lj nedan"]))) : Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["L"])(templateObject_3 || (templateObject_3 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["Visa hela texten fr\u00E5n Skolverket"], ["Visa hela texten fr\u00E5n Skolverket"])))),
...
function updateDocumentGraphs(oldDoc, newDoc, table, graphs, batch) {
    ...
    var _loop_1 = function (navProp) {
        ...
        try {
            for (var added_1 = (e_2 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(added)), added_1_1 = added_1.next(); !added_1_1.done; added_1_1 = added_1.next()) {
                var a = added_1_1.value;
                var mutatedSubDoc = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, a.doc);
        ...
        try {
            for (var removed_1 = (e_3 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(removed)), removed_1_1 = removed_1.next(); !removed_1_1.done; removed_1_1 = removed_1.next()) {
        ...
        try {
            for (var updated_1 = (e_4 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(updated)), updated_1_1 = updated_1.next(); !updated_1_1.done; updated_1_1 = updated_1.next()) {
                var u = updated_1_1.value;
                var mutatedSubDoc = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, u.doc);
    ...
    try {
        for (var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(Object.keys(graphs)), _c = _b.next(); !_c.done; _c = _b.next()) {
...
function applyEtags(doc, newEtags, graphs) {
    var e_5, _a;
    var res = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, doc);
    var etag = newEtags[doc.id];
    if (etag)
        res.$etag = etag;
    try {
        for (var graphs_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(graphs), graphs_1_1 = graphs_1.next(); !graphs_1_1.done; graphs_1_1 = graphs_1.next()) {
                ...
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all([
                            client.list("courses", {
                                ...
                                var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(_a, 1), result = _b[0];
                                if (!result)
                                    throw new kedbackend_client__WEBPACK_IMPORTED_MODULE_2__["HttpError"](404, "Course with id " + id + " was not found");
                                return result;
                            }),
...
var TextAreaFormField = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(TextAreaFormField, _super);
...
function liveQueryView(fn, options) {
    return function (props) {
        return react__WEBPACK_IMPORTED_MODULE_1__["createElement"](LiveQueryView, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({ props: props, fn: fn }, options));
    };
}
var LiveQueryView = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(LiveQueryView, _super);
            ...
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", { style: { outline: 'none' }, tabIndex: 0, onBlur: function (ev) { return setTimeout(function () { return _this.setState({ optionsVisible: false }); }, 100); } },
                ...
                optionsVisible ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null,
                    ...
                    filteredOptions ?
                        ...
                        react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_course_builder_sub_components_spinner__WEBPACK_IMPORTED_MODULE_2__["TimeoutSpinner"], null)) :
                    undefined));
    };
    return Multiselect;
}(react__WEBPACK_IMPORTED_MODULE_1___default.a.Component));
...
_globals_KED_cfg__WEBPACK_IMPORTED_MODULE_0__["default"].KED_SCHEDULE_TOKEN_API_URL = "https://inssprofile.kunskapsskolan.nl/api/external/";
_globals_KED_cfg__WEBPACK_IMPORTED_MODULE_0__["default"].KED_SCHEDULE_BASE_API_URL = "https://inssplanning.kedschools.in/api/external/";
...
/* harmony import */ var _set_kedSchedule_client__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./set-kedSchedule-client */ "./src/global-setters/set-kedSchedule-client.ts");
...
/***/ "./src/global-setters/set-kedSchedule-client.ts":
/*!******************************************************!*\
  !*** ./src/global-setters/set-kedSchedule-client.ts ***!
  \******************************************************/
/*! no exports provided */
...
/* harmony import */ var _globals_KED_cfg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../globals/KED.cfg */ "./src/globals/KED.cfg.ts");
/* harmony import */ var kedbackend_clientweb__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! kedbackend/clientweb */ "./kedbackend/clientweb.js");
/* harmony import */ var _apis_ked_scheduleclient__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../apis/ked-scheduleclient */ "./src/apis/ked-scheduleclient.ts");
/* harmony import */ var _apis_bearer_ked_schedule__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../apis/bearer-ked-schedule */ "./src/apis/bearer-ked-schedule.ts");





_globals_KED_env__WEBPACK_IMPORTED_MODULE_0__["default"].kedScheduleClient = new _apis_ked_scheduleclient__WEBPACK_IMPORTED_MODULE_3__["KedScheduleClient"](kedbackend_clientweb__WEBPACK_IMPORTED_MODULE_2__["isomorphic"], _globals_KED_cfg__WEBPACK_IMPORTED_MODULE_1__["default"].KED_SCHEDULE_BASE_API_URL, new _apis_bearer_ked_schedule__WEBPACK_IMPORTED_MODULE_4__["KedScheduleBearerProvider"](_globals_KED_cfg__WEBPACK_IMPORTED_MODULE_1__["default"].KED_SCHEDULE_TOKEN_API_URL));
...
/*!************************************!*\
  !*** ./src/utils/school-moment.ts ***!
  \************************************/
/*! exports provided: getFirstAndLastWeekOfTerm, getNlAcademicYear, getTermStarEndDate, getSchoolMoment, addYear, nextAcademicYear, prevAcademicYear */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getNlAcademicYear", function() { return getNlAcademicYear; });
...
// }
function getNlAcademicYear(date) {
    var firstWeekMoment = null;
    var lastWeekMoment = null;
    var endOfTermDate = moment__WEBPACK_IMPORTED_MODULE_1___default()(new Date(date.getFullYear(), 7, 1)).startOf("isoWeek").startOf("day").toDate();
    if (date < endOfTermDate) {
        firstWeekMoment = moment__WEBPACK_IMPORTED_MODULE_1___default()(date).clone().subtract(1, "year").month(7).startOf("month").startOf("isoWeek");
        lastWeekMoment = moment__WEBPACK_IMPORTED_MODULE_1___default()(date).clone().month(6).endOf("month").endOf("isoWeek");
    }
    else {
        firstWeekMoment = moment__WEBPACK_IMPORTED_MODULE_1___default()(date).clone().month(7).startOf("month").startOf("isoWeek");
        lastWeekMoment = moment__WEBPACK_IMPORTED_MODULE_1___default()(date).clone().add(1, 'year').month(6).endOf("month").endOf("isoWeek");
    }
    return [firstWeekMoment, lastWeekMoment];
}
function getTermStarEndDate(date, isFirstTerm) {
    ...
    //kedschedule hardcoded for current year
...
function compareProps(props, locales, options, descending) {
    props = Array.isArray(props) ? props : [props];
    var localeCompare = function (a, b) {
        return typeof a === 'string' ?
            a.localeCompare(b, locales, options) :
            a < b ? descending ? 1 : -1 : a > b ? descending ? -1 : 1 : 0;
    };
