...
function resolveRequirementOrder(obj, orderDefiner) {
    ...
    if (orderDefiner) {
        ...
        orderDefiningDocObservable = (_a = _globals_db__WEBPACK_IMPORTED_MODULE_2__["db"].courses).tags.apply(_a, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](courseCodes)).cacheOptimized().toValue();
    }
                ...
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all([
                            client.list("courses", {
                                ...
                                var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 1), result = _b[0];
                                if (!result)
