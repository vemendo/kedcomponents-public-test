...
var FilteredStudentView = ((function (_a) {
    ...
    selectedCourse.modules.map(function (m) { return moduleTasks[m.name] = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](tasks.filter(function (t) { return m.taskIds.find(function (tId) { return tId === t.id; }); })); });
...
function setupEmail(WrappedComponent) {
    return function (props) {
        var _a = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])({ emailSendInProgress: false, data: [] }), 2), emailInfo = _a[0], setEmailInfo = _a[1];
        ...
        var setRecipients = function (recipient) { return setEmailInfo(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, emailInfo, { data: emailInfo.data.find(function (su) { return su.sendTo.email === recipient.sendTo.email && recipient.taskId === su.taskId; }) ?
                emailInfo.data.filter(function (u) { return u.sendTo.email !== recipient.sendTo.email || recipient.taskId !== u.taskId; }) : tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](emailInfo.data, [recipient]) })); };
        ...
        return react__WEBPACK_IMPORTED_MODULE_1__["createElement"](WrappedComponent, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, props, { emailInfo: emailInfo, setEmailInfo: setRecipients, sendReminder: sendReminder }));
    };
}
...
var AssignmentsView = (function () {
    ...
    var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])({ selectedStudent: { label: null, value: null }, selectedStudyGroups: [] }), 2), filterData = _b[0], setFilteringData = _b[1];
                        ...
                        react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: "sv-row sv-layout sv-skip-spacer" },
                            react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: "horizontalItem top pull-right study-group-filter" },
                                react__WEBPACK_IMPORTED_MODULE_1__["createElement"](react_select__WEBPACK_IMPORTED_MODULE_5__["default"], { isDisabled: filterData.selectedStudent.value, isMulti: true, options: selectedCourse.studyGroups.map(function (sg) { return ({ label: sg, value: sg }); }), value: filterData.selectedStudyGroups.map(function (group) { return ({ label: group, value: group }); }), placeholder: intl.formatMessage({ id: "teacherView.filterByStudygroupsPlaceholder", defaultMessage: "Välj undervisningsgrupp" }), onChange: function (options) {
                                        setFilteringData(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, filterData, { selectedStudyGroups: options.map(function (_a) {
                                                var value = _a.value;
                                                return value;
                                            }) }));
                                    } })),
...
/* harmony import */ var _utility_components_observe__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utility-components/observe */ "./src/components/utility-components/observe.tsx");
/* harmony import */ var _course_builder_sub_components_ellipsis_loader__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../course-builder/sub-components/ellipsis-loader */ "./src/components/course-builder/sub-components/ellipsis-loader.tsx");
...
var DigestView = Object(react_router__WEBPACK_IMPORTED_MODULE_2__["withRouter"])((function (_a) {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1__["createElement"](StateContext.Provider, { value: contextValue },
        react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_course_builder_ks_common_two_columns_page__WEBPACK_IMPORTED_MODULE_3__["TwoColumnsPage"], { left: react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_utility_components_observe__WEBPACK_IMPORTED_MODULE_11__["Observe"], { fallback: react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_course_builder_sub_components_ellipsis_loader__WEBPACK_IMPORTED_MODULE_12__["EllipsisLoader"], null) },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "teacher-view" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Route"], { path: "/overview/(course)?/:courseId?/(assignments)?", render: function () {
                    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_utility_components_observe__WEBPACK_IMPORTED_MODULE_2__["Observe"], { fallback: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_course_builder_sub_components_ellipsis_loader__WEBPACK_IMPORTED_MODULE_3__["EllipsisLoader"], null) },
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_digest_view__WEBPACK_IMPORTED_MODULE_4__["DigestView"], { courseBuilderUrl: courseBuilderUrl, courseViewerUrl: viewCourseUrl }));
                } }),
    ...
    _KEDAppTeacherView.prototype.render = function () {
        ...
        return this.state.isTokenLoaded ?
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"](_components_utility_components_LanguageContext__WEBPACK_IMPORTED_MODULE_8__["LanguageContext"].Provider, { value: { intl: intl } },
                react__WEBPACK_IMPORTED_MODULE_4__["createElement"](_components_teacher_view__WEBPACK_IMPORTED_MODULE_5__["TeacherViewApp"], { courseBuilderUrl: _globals_KED_cfg__WEBPACK_IMPORTED_MODULE_3__["default"].KED_COURSE_BUILDER_URL, viewCourseUrl: _globals_KED_cfg__WEBPACK_IMPORTED_MODULE_3__["default"].KED_COURSE_VIEWER_URL }),
                "/>") :
