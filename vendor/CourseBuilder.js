...
var ClassroomSync = /** @class */ (function (_super) {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        // project in GAS
                        data.devMode = false;
                        return [4 /*yield*/, _globals_KED_env__WEBPACK_IMPORTED_MODULE_2__["env"].bearerProvider.getBearer()];
                    case 2:
                        KEDToken = _a.sent();
    ...
    */
    ClassroomSync.prototype.initSync = function (course, origCourse, fullSyncNeeded) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var data, edsSchoolNameGymn, studyGroupStudents, _a, _b, group, tuitionGroupStudents, e_1_1, _c, subset, changes;
            var e_1, _d;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, _globals_KED_env__WEBPACK_IMPORTED_MODULE_2__["env"].kedBackendClient.http.get('schools', { 'cacheBust': 'static', 'name': course.school }).then(function (resp) { return resp.json(); })];
                    case 1:
                        data = _e.sent();
                    ...
                    case 2:
                        ...
                        _a = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(course.studyGroups), _b = _a.next();
                        _e.label = 3;
                    case 3:
                        if (!!_b.done) return [3 /*break*/, 6];
                        group = _b.value;
                        return [4 /*yield*/, _globals_KED_env__WEBPACK_IMPORTED_MODULE_2__["env"].edsClient.getTuitionGroupStudents({ schoolName: edsSchoolNameGymn, tuitionGroupName: group })];
                    case 4:
                        tuitionGroupStudents = _e.sent();
                    ...
                    case 8:
                        ...
                        return [7 /*endfinally*/];
                    case 9:
                        _c = this.diffCourse(course, origCourse), subset = _c.subset, changes = _c.changes;
    ...
    EditCourse.prototype.render = function () {
        ...
        return !this.state.course ? react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { style: { outline: 0 } },
            ...
            react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("p", null,
                react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_sub_components_spinner__WEBPACK_IMPORTED_MODULE_13__["TimeoutSpinner"], null),
            ...
            react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: "sv-layout sv-column-6" },
                react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: "sv-html-portlet sv-portlet sv-skip-spacer" },
                    isSearching && react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("p", null,
                        react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_sub_components_spinner__WEBPACK_IMPORTED_MODULE_11__["TimeoutSpinner"], null),
                        " Laddar uppgifter..."),
                    searchResult ?
                        /*
                        *
        ...
        return react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: "sv-html-portlet sv-portlet sv-skip-spacer" },
            react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: "ked_boxed" },
                ...
                react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: "taskContainer odd-even" }, !schoolCourses ?
                    react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("p", null,
                        react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_spinner__WEBPACK_IMPORTED_MODULE_4__["TimeoutSpinner"], null),
...
var SelectStudyGroups = Object(_utility_components_with_observe__WEBPACK_IMPORTED_MODULE_6__["withObserve"])(function (_a) {
    ...
    var options = studyGroups ? studyGroups.map(function (sg) { return ({
...
var SelectTeacher = Object(_utility_components_with_observe__WEBPACK_IMPORTED_MODULE_8__["withObserve"])(function (_a) {
    //
    ...
    var edsTeachers = _globals_KED_env__WEBPACK_IMPORTED_MODULE_3__["env"].edsClient.suspense.getSchoolTeachers({ schoolName: edsSchoolNameGymn });
